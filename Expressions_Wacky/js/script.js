...
ad[15] = prompt("Please enter just one more noun below.");
ad[16] = prompt("Please enter a verb below. Almost there.");
ad[17] = prompt("Please enter a noun below. Then you are DONE!");
