...
var happy;               //this is the first variable that the user will pick from the if/ else statements below. It will tell them an alert.
var angry;             //this is the second variable that the user will pick from the if/ else statements below. It will tell them an alert.
var mischievous;        //this is the third variable that the user will pick from the if/ else statements below. It will tell them an alert.
...
if (answer === "happy"){            //if the user picked "happy" the program will print out the alert below
    ...
    alert("Gears of War 3, no doubt, Gears of war 3. Blood, death, AWESOMENESS, murder and mayhem!!  Nothing better, you will get up sweating.");    //the alert to be printed based on the user's choice above

}else if(answer === "mischievous"){        //if the user picked "mischievous" the program will print out the alert below
    alert("No doubt, Assasin's Creed 3. Steal from old ladies, slit throats and keep walking, drink beer and cause all sorts of ruckus. Too much fun!");    //the alert to be printed based on the user's choice above
